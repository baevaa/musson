(() => {
    ...
    var langActive = document.querySelector(".languaje__list");
    var i;
    for (i = 0; i < langActive.children.length; i++) langActive.children[i].querySelector("a").onclick = addp;
    function addp() {
        for (i = 0; i < langActive.children.length; i++) langActive.children[i].querySelector("a").classList.remove("active-lang");
        this.classList.add("active-lang");
        iconLang.classList.remove("lang-open");
        menuCatalog.classList.remove("lang-open");
    }
